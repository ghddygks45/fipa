$(document).ready(function () {
	...
	var popupzone = new Swiper(".popup_wrap", {
		...
		navigation: {
			nextEl: ".popupzone .btn_next",
			prevEl: ".popupzone .btn_prev",
		}
	});

	$('.popupzone .btn_pause').click(function () {
		$('.popupzone .btn_pause').hide();
		$('.popupzone .btn_play').show();
		popupzone.autoplay.stop();
	});

	$('.popupzone .btn_play').click(function () {
		$('.popupzone .btn_play').hide();
		$('.popupzone .btn_pause').show();
